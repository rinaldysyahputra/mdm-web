...
export const TransactionsTable = () => {
  const totalTransactions = jobSeekersDetail.length;
  ...
  const pagesTransaction = paginate(jobSeekersDetail, currentPage, pageSize);
  ...
  const TableRow = (props) => {
    ...
    return (
      <tr>
        ...
        <td>
          <span className="fw-normal">{answers}</span>
        </td>
        <td>
          <span className="fw-normal">{recomendation}</span>
        </td>
        <td>
          <span className="fw-normal">{result}</span>
        </td>
        {/* <td>
      ...
      <Card.Body className="pt-0">
        <thead>
          <tr>
            ...
            <th className="border-bottom">Recommendation</th>
            <th className="border-bottom">Result</th>
            {/* <th className="border-bottom">Action</th> */}
          </tr>
        </thead>
        <tbody>
          {pagesTransaction.map((t) => (
